...
class GLFrame(OpenGLFrame):
    ...
    def _init_geometry(self):
        ...
        self._position_vbo = GL.glGenBuffers(1)
        ...
        position_location = GL.glGetAttribLocation(self._program_ref, "position")
        GL.glEnableVertexAttribArray(position_location)
        GL.glVertexAttribPointer(position_location, 3, GL.GL_FLOAT, False, 0, None)
