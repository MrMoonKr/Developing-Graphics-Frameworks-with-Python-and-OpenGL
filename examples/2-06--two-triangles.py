...
class GLFrame(OpenGLFrame):
    ...
    def draw_scene(self):
        ...
        GL.glUniform3f(self._translation_loc, -0.5, 0.0, 0.0)
        GL.glUniform3f(self._base_color_loc, 1.0, 0.0, 0.0)
        GL.glDrawArrays(GL.GL_TRIANGLES, 0, self._vertex_count)

        GL.glUniform3f(self._translation_loc, 0.5, 0.0, 0.0)
        GL.glUniform3f(self._base_color_loc, 0.0, 0.0, 1.0)
        GL.glDrawArrays(GL.GL_TRIANGLES, 0, self._vertex_count)
